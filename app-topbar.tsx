    ...
    <header className="w-full px-3 pt-3 sm:px-4 sm:pt-4 md:px-6 md:pt-8">
      <div className="relative mx-auto flex w-full max-w-6xl items-center justify-between rounded-xl border border-border/10 bg-background-elevated/[0.48] px-3 py-2.5 sm:px-3.5 md:px-4.5 md:py-3">
        ...
        <div className="flex items-center gap-2">
          <WalletConnectButton className="inline-flex h-9 items-center justify-center rounded-md border border-border/[0.14] bg-surface-2/[0.62] px-3 font-mono text-[10px] uppercase tracking-[0.12em] text-foreground transition-colors hover:border-border-strong" />
          <LocaleMenu
            locale={locale}
